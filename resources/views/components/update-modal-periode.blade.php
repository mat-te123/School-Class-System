<x-update-modal subtext="Mengubah data periode" type="Periode">
    ...
    <form :action="updateUrl" method="POST" class="flex flex-col gap-3" novalidate
        ...
        <div class="flex flex-col gap-1">
            ...
            <input name="nama_periode" id="fnama_periode_edit" type="text" x-model="Data.nama_periode"
        ...
        <div class="flex flex-row justify-between gap-3">
            <div class="flex flex-col gap-1 w-full">
                ...
                <select name="gelombang" id="fgelombang_edit"
                    class="border border-black rounded-lg py-1 px-4 text-base w-full" x-model="Data.gelombang">
            ...
            <div class="flex flex-col gap-1 w-full">
                ...
                <input name="max_pilihan_siswa" id="fmax_pilihan_siswa_edit" type="number"
                    class="border border-black rounded-lg py-1 px-4 text-base w-full" x-model="Data.max_pilihan_siswa">
            </div>
        </div>
        ...
        <div class="flex flex-row justify-between gap-3 w-full">
            <div class="flex flex-col gap-1 w-full">
                ...
                <input name="tanggal_buka" id="ftanggal_buka_edit" type="date"
                    class="border border-black rounded-lg py-1 px-4 text-base w-fit" x-model="Data.tanggal_buka">
            </div>
            ...
            <div class="flex flex-col gap-1 w-12.5">
                ...
                <input name="tanggal_tutup" id="ftanggal_tutup_edit" type="date"
                    class="border border-black rounded-lg py-1 px-4 text-base w-12.5" x-model="Data.tanggal_tutup">
            </div>
        </div>
